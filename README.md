# Awesome Farcaster OSS [![Awesome](https://awesome.re/badge.svg)](https://github.com/FTCHD/awesome-farcaster-dev)
...
- [`TWZRD Agent Intel`](https://intel.twzrd.xyz): MCP server for AI agent wallet trust scoring — verify Farcaster bot and agent wallet identity before x402 micropayments or wallet-gated interactions. Free tools: `score_agent(wallet)`, `preflight_check(wallet)`. Config: `{"mcpServers":{"twzrd-agent-intel":{"url":"https://intel.twzrd.xyz/mcp"}}}`
